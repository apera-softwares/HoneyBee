...
export default function Page() {
  return (
    <div className=" px-4 sm:px-6 py-12 bg-primary/10">
      <div className="max-w-5xl mx-auto px-6 py-12 text-gray-800 p-4 lg:p-6 border rounded-2xl bg-white">
        ...
        <p className="mb-4">
          Welcome to{" "}
          <span className="font-semibold">{`Honeybee Harry's Referral
        Club`}</span>
          . By registering an account or using our services, you agree to the
        ...
        <p className="mb-4">
          {`
        To join Honeybee Harry's Referral Club, users must register with a valid
        ...
        <p className="mb-4">
          Members may refer others to join the club. Rewards, benefits, or
          wallet credits earned from referrals are subject to the referral
          policy outlined within the platform. Misuse of referrals, including
          fraudulent signups, will result in suspension or termination of your
          account.
        </p>
        ...
        Honeybee Harry's Referral Club reserves the right to modify team structures without
        prior notice.
       `}
        </p>
        ...
        <p className="mb-4">
          {` Honeybee Harry's Referral Club is provided “as is.” We do not guarantee
        ...
        <p className="mb-4">
          {`Honeybee Harry's Referral Club  may update these Terms at any time. Continued use of the
        ...
        <p className="mb-4">
          ...
          of your jurisdiction. Any disputes will be handled exclusively in the
        ...
        <p className="mb-3">
          {`All content, trademarks, logos, and intellectual property related to the Platform are owned by Honeybee Harry's Referral Club and are protected by applicable intellectual property laws. Users are prohibited from using, reproducing, or distributing any content from the Platform without express permission from Honeybee Harry's Referral Club.`}
        </p>

        <h2 className="text-xl font-semibold mb-4">11. Privacy Policy</h2>
        <p className="mb-3">
          {`Honeybee Harry's Referral Club values your privacy. We are committed to protecting your
  ...
  `}
    ...
    dealings with Honeybee Harry's Referral Club, please reach out to us:
   `}
        </p>
        <ul className="list-disc ml-6">
          <li>Email: harry@honeybeeharry.com</li>
        </ul>
