                            ...
                            {images.length > 0 ? (
                                <>
                                    ...
                                    <button
                                        onClick={prevSlide}
                                        disabled={isFirst}
                                        className={`absolute left-3 top-1/2 -translate-y-1/2 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow ${isFirst ? "opacity-50 cursor-not-allowed" : "opacity-100"
                                            }`}
                                    >
                                    ...
                                    <button
                                        onClick={nextSlide}
                                        disabled={isLast}
                                        className={`absolute right-3 top-1/2 -translate-y-1/2 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow ${isLast ? "opacity-50 cursor-not-allowed" : "opacity-100"
                                            }`}
                                    >
